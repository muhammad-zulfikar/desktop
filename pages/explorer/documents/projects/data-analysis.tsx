...
function Projects({ data }: { data: ProjectType[] }) {
	...
	return (
		<>
			<Head>
				<title>Zulfikar - Data Analysis</title>
				<link
					rel="canonical"
					href="https://zulfikar-desktop.web.app/explorer/documents/projects/data-analysis"
				/>
				...
				<meta
					property="og:url"
					content="https://zulfikar-desktop.web.app/explorer/documents/projects/data-analysis"
				/>
				<meta
			...
			<div style={{ height: '100%' }}>
				<FileExplorer
					icon="folder"
					folder="Documents/Projects/Data Analysis"
					component={content()}
					topNav={true}
				/>
				<Icons />
...
export async function getStaticProps() {
    ...
    const data = (await res.json()).filter(
        (project: ProjectType) =>
            project.fork === false &&
            project.full_name !== 'muhammad-zulfikar/muhammad-zulfikar' &&
            project.topics.includes('data-analysis')
    );
